function [tabela] = rezultati_splosna(n_poizkusov,n_premic)
    ...
    n_tock = [20 40 80 200];%Vektor števila to?k, na katerih generiramo krivulje
    for j = 1:4
        for i = 1:n_poizkusov
    ...
    %Dvojna for zanka za vsako krivuljo z dolo?enim številom to?k,
    %"n_poizkusov"-krat pokli?e funkcijo verjetnost. Nato v prvi stolpec
    %matrike shranimo razmerje sekanj ve?je in manjše krivulje. V 2.
    %stolpec zapišemo razmerje obsegov. V 3. stolpcu je absolutna razlika
    %vrednosti v prvih dveh stolpcih, v 4. pa predzna?ena. V 5. stolpcu
    %je navedeno število sekanj ve?je od krivulj.
end
